...
public class Library extends JFrame {
	...
	public Library() {
		...
		lblLibraryManagement.setFont(new Font("Tahoma", Font.PLAIN, 50));
		...
		btnAdminLogin.setFont(new Font("Tahoma", Font.PLAIN, 40));
		...
		btnLibrarianLogin.setFont(new Font("Tahoma", Font.PLAIN, 40));
